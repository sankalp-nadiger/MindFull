  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
    <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
      ...
      <div class="hidden absolute top-2/4 end-0 transform -translate-y-2/4 translate-x-40 md:block lg:translate-x-80" aria-hidden="true">
        ...
        <section class="text-white-600 body-font overflow-hidden bg-gradient-to-b from-black via-green-500 to-black">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-12">
      <div class="p-12 md:w-1/2 flex flex-col items-start text-white">
        <span class="inline-block py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest">CATEGORY</span>
        <h2 class="sm:text-3xl text-2xl title-font font-medium text-white-900 mt-4 mb-4">Roof party normcore before they sold out, cornhole vape</h2>
      ...
      <div class="p-12 md:w-1/2 flex flex-col items-start text-white">
        <span class="inline-block py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest">CATEGORY</span>
        <h2 class="sm:text-3xl text-2xl title-font font-medium text-white-900 mt-4 mb-4">Pinterest DIY dreamcatcher gentrify single-origin coffee</h2>
...
<section class="text-gray-400 bg-gradient-to-b from-black via-blue-700 to-black body-font">
  <div class="container px-5 py-24 mx-auto">
