...
const RoleSelection = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-950 via-purple-900 to-black text-white px-6">
      ...
      <div className="w-full max-w-md p-6 bg-gray-900 shadow-lg rounded-lg flex flex-col items-center">
        ...
        <button
          className="mt-2 px-6 py-2 font-semibold bg-gray-700 text-white rounded-md hover:bg-gray-600 transition-all"
          onClick={() => navigate('/')} // Assuming you're using React Router
        >
          Go Back to Home
        </button>
      </div>
